...
La existencia de Unter se acredita por dos vías independientes.

\begin{enumerate}
\item \textbf{Presencia pública verificable.} Sitio web oficial de la empresa: \url{https://unter.cl} (consultado el 12 de septiembre de 2026).
\item \textbf{Entrevista al encargado.} Se realizó una primera instancia de levantamiento en modalidad informal y luego la entrevista formal, grabada en audio y transcrita íntegramente. Ambos archivos están en el repositorio GitHub, en la carpeta \path{informe/}: \path{ICN292_P100_AudioEntrevista.mp4} y \path{ICN292_P100_TranscripcionEntrevista.txt}.
\end{enumerate}
